        ...
        (usuario:_) -> do
            ...
            case resultado of
                Left erro -> do
                    ...
                    _ <- getLine
                    return (livros, registros)
                Right (novosLivros, maybeRegistro) -> do
                    putStrLn "Empréstimo processado!"
                    _ <- getLine
                    let novosRegistros = case maybeRegistro of
                                            Just r  -> r : registros
                                            Nothing -> registros
                    return (novosLivros, novosRegistros)
